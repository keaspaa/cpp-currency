    ...
    public:
        ...
        TEST_METHOD(TestMaxDifference)
        {
            std::vector<CurrencyRate*> rates = {
                new CurrencyRate{"USD", 85.0, 90.0, "Branch1"},
                new CurrencyRate{"EUR", 87.0, 88.0, "Branch1"},
                new CurrencyRate{"GBP", 70.0, 75.0, "Branch2"}
            };
        ...
        {
            std::vector<CurrencyRate*> rates = {
                new CurrencyRate{"JPY", 100.0, 98.0, "Branch1"},
                new CurrencyRate{"CNY", 95.0, 97.0, "Branch1"}
            };
